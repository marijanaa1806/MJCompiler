...
public class ErrorFormParRp extends MethodDeclElement {
    ...
    public ErrorFormParRp (MethodTypeName MethodTypeName, EndFormPar EndFormPar, VarDeclLista VarDeclLista, StatementList StatementList) {
